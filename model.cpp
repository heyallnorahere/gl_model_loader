...
mesh model::process_mesh(aiMesh* mesh) {
	...
	if (mesh->mMaterialIndex >= 0) {
		...
		vector<texture> normalMaps = this->load_material_textures(material, aiTextureType_HEIGHT, "texture_height");
		textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
		vector<texture> heightMaps = this->load_material_textures(material, aiTextureType_AMBIENT, "texture_normal");
